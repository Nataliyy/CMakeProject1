18 Лаба
Инструкция пользователя: При запуске программы открывается "записная книжка", в которой указаны фио и номера телефонов рабочих. Можно выполнить поиск сотрудника по номеру/имени и удалить рабочих
